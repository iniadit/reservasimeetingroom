...
if (isset($_GET['date'])) {
    $date = $_GET['date'];
    // UBAH BOOKINGS SESUAI DATABASE
    $stmt = $mysqli->prepare("select * from chrysant where date = ?");
...
if(isset($_POST['submit'])){
    ...
    $timeslot = $_POST['timeslot'];
                             // UBAH BOOKINGS SESUAI DATABASE
    $stmt = $mysqli->prepare ("select * from chrysant where date = ? AND timeslot =  ?");
    ...
    if($stmt->execute()){
        ...
        if($result->num_rows>0){
          $msg = "<div class='alert alert-Danger'>Already Booked</div>";
                             ...
                             // UBAH BOOKINGS SESUAI DATABASE
          $stmt = $mysqli->prepare("INSERT INTO chrysant (name, timeslot, email, date) VALUES (?,?,?,?)");
      ...
      <div class="modal-body">
        <div class="row">
            ...
            <form action="" method="post">
                    ...
                    <div class="form-group">
                     <label for="">Mohon input data diri dengan benar</label>
                    </div>
