    ...
    while ($currentDay <= $numberDays) {
       ...
       if($dayname=="II $dayname=="){
        ...
        if ($totalbookings == 10) {
            ...
            $availableslots = 10 - $totalbookings;                // UBAH BOOK SESUAI no index.php samakan dengan book.php
            $calendar .= "<td class='$today'><h4>$currentDay</h4>
            <a href='http://localhost/ta/book/skyballroom.php?date=" . $date . "' class='btn
...
function checkSlot($mysqli, $date){
    $stmt = $mysqli->prepare ("select * from skyballroom where date = ?"); // UBAH BOOKINGS SESUAI DATABASE
